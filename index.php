		...
		<div class='main-content' >
			...
			<div class='sections' >
				...
				<section id='about' class='section about-section border-d' >
					...
					<div class='section-block about-block' >
						<div class='container-fluid' >
							...
							<div class='section-header' >
								<h2>
									<strong class='color' >The Boss</strong>
								</h2>
							</div>
							...
							<div class='row' >
								...
								<div class='col-md-4' >
									...
									<ul class='info-list' >
										...
										<li>
											<strong>Job:</strong>
											<span>Tech architect extraordinare</span>
										</li>
								...
								<div class='col-md-8' >
									...
									<div class='about-text' >
										<p>
											Almo devs was founded in 2019, on the principle of delivering sound tech without all the headaches. Tech is what we do and we do it good. Our history has shown lots of successful project complementions thanks to our own expertise as well as that of our netwrok partners who assist us in our tech builds.
										</p>
										
										<p>
											We pride ourselves on quality but we also appreciate simplicity and elegance in delivering solutions. Whilst we haven't been on the market for too long, our work raises the bar in solutions for individuals and corporations.
										</p>
					...
					<div class='section-block services-block' >
						...
						<div class='container-fluid' >
							...
							<div class='section-header' >
								...
								<h2>Our <strong class='color' >Services</strong></h2>
								...
								<div class='col-md-6' >
									<div class='service' >
										...
										<div class='content' >
											...
											<p>
												We partner with the best in the business to design and deliver the best looking e-mail templates with the fraction of the cost. 
												<br />
												<br />
												If you need the right-looking temlates for your brand to really engage your customers for every communication, speak to us
												about awhat you want to achieve and what you would love to have represent you.
											</p>
								...
								<div class='col-md-6' >
									<div class='service' >
										...
										<div class='content'>
											...
											<p>
												Our vast array of experience in build websites from scratch is second to none. Having now reach 7+ years in the industry, we have wealth of talent
												catering to your needs to place your brand on the web, beautifully and communicate to your audience effectively. From design, development and then delivery to the internet,
												we take step by step to ensure you get the very best.
												<br />
												<br />
												Have a look at our portfolio to see a range of our work and what we have brought to fruition.
											</p>
					...
					<div class='section-block skills-block' >
						<div class='container-fluid' >
							...
							<div class='section-header' >
								...
								<h2>
									Our <strong class='color' >Skill set</strong>
								</h2>
					...
					<div class='section-block pricing-block hide' >
						
						<div class='section-header' >
							<h2>Our <strong class='color' >Pricing</strong></h2>
						</div>
					...
					<div class='section-block portfolio-block' >
						...
						<div class='container-fluid' >
							...
							<ul class='portfolio-filters' >
								...
								<li>
									<a href='#' class='active' data-group='web' >
										Web
									</a>
								</li>
								<li>
									<a href='#' data-group='email' >
										Email
									</a>
								</li>
								<!--<li>
